class ConfiguracionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @configuracion.save
        format.html { redirect_to main_page_index_path, notice: 'Bien Hecho. La configuración ha sido registrada.' }
  ...
  private
    ...
    def configuracion_params
      params.require(:configuracion).permit(:tasa, :prc_enganche, :plazo_maximo)
    end
end
